...
(III)which in turn is used to predict new values:

$$\tilde{y}^* = \bm{X}\bm{\hat{\beta}}$$.
...
Step I-IV is then repeated $B$ times, while keeping track of each sample MSE.
